...
## ~~CourseInstructor — Grade Distribution~~ — resolved, per-course student list ยังไม่ได้ทำ
...
**ยังไม่ได้ทำ**: "Student ที่เกี่ยวข้อง" (raw student list ต่อ course สำหรับ INSTRUCTOR) — คนละ scope จาก Grade Distribution รอบนี้ไม่แตะ ยังเป็น business logic ใหม่ที่ต้องออกแบบแยก (course filter + INSTRUCTOR branch ใน `StudentCourseRecordService.findAll`)
